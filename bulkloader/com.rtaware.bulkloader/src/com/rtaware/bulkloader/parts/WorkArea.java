...
public class WorkArea 
{
	...
	private static List<FlowVariable> 	variableList 	= new ArrayList<>();;
	
	public List<FlowVariable> getVariableList()
	{
		return variableList;
	}

	public static void setVariableList(List<FlowVariable> variableList)
	{
		WorkArea.variableList = variableList;
